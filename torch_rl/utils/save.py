...
def get_log_path(model_dir, log_file="log.txt"):
    return os.path.join(model_dir, log_file)

def get_logger(model_dir, log_file="log.txt"):
    path = get_log_path(model_dir, log_file=log_file)
    utils.create_folders_if_necessary(path)
