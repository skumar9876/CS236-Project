...
parser.add_argument("--num_test_environments", type=int, default=10, 
                    help="The number of environments to evaluate on.")
...
for i in range(args.procs):
    ...
    for j in range(100*i):
        env.reset()
    env.num_test_environments = args.num_test_environments
